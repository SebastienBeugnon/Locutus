 ...
 * 
 */
public class TextFieldRechercheVoix extends JTextField implements
		DocumentListener {
	 ...
	 * @param vs
	 */
	public TextFieldRechercheVoix(String text, VueVoix vs) {
		super(text);
	...
	public void insertUpdate(DocumentEvent arg0) {
		this.vs.rechargerVueListeConcept(this.vs.getModuleInterne()
