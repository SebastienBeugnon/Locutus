 ...
 * 
 */
public class TextFieldRechercheConcepts extends JTextField implements
		DocumentListener {
	...
	private VueCoursSelection vs;

	/**
	 * @param text
	 * @param vs
	 */
	public TextFieldRechercheConcepts(String text, VueCoursSelection vs) {
		super(text);
	...
	public void insertUpdate(DocumentEvent arg0) {
		this.vs.reload(this.vs.getModuleInterne().rechercheParNom(
				this.getText()));
	}
